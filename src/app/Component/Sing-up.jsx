            ...
            <div className="flex w-full h-full  flex-col overflow-hidden    text-slate-500 sm:flex-row">
                ...
                <figure className="flex-1">
                    <div className='flex items-center h-full'>
                        <Image src={img} width={500} height={500} className='w-full h-full' />
                    </div>

                </figure>
                {/*  <!-- Body--> */}
                <div className="flex-1 p-6 px-7 sm:mx-6 sm:px-0 border  custom-shad rounded-md ">
                    <header className="flex gap-4 mb-4 px-5">
                        <div>
                    ...
                    <div className='px-7'>
                        <form onSubmit={signupHandler}>
                            ...
                            <input type='submit' value='Create Account' className="h-[56px] cursor-pointer inline-flex    w-full items-center justify-center  gap-2 px-6 text-sm font-medium tracking-wide text-white transition duration-300 rounded focus-visible:outline-none whitespace-nowrap bg-gradient-to-r from-emerald-600 to-emerald-800 hover:bg-emerald-600 focus:bg-emerald-700 disabled:cursor-not-allowed disabled:border-emerald-300 disabled:bg-emerald-300 disabled:shadow-none" />
                        </form>
                        ...
                        <p className='text-sm my-20 text-center text-primary'>Alredy Have An Account ? <Link href='/login'>Login</Link></p>
                    </div>
